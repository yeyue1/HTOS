 ...
 */
#define TLSF_SL_INDEX_COUNT_LOG2 4 /* 二级索引位数 (2^4=16个二级索引) */
#define TLSF_FL_INDEX_MAX 13 /* 最大一级索引值 (支持最大2^13字节) */
#define TLSF_SL_INDEX_COUNT (1 << TLSF_SL_INDEX_COUNT_LOG2) /* 16个二级索引 */
